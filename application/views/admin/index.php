    ...
    <section class="content">
      ...
      <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <a href="<?php echo base_url() ?>index.php/product" class="small-box-footer">Mas info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
              ...
              <div class="box box-danger">
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
                      <p class="text-center">
                        <strong>Ventas: 1 Enero, <?php echo date('Y'); ?> - 31 Diciembre, <?php echo date('Y'); ?></strong>
                      </p>
                      <div class="chart">
                        <!-- Sales Chart Canvas -->
      ...
      <div class="col-md-4">
        <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Reporte de venta por porducto</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                  </div>
      ...
      <!-- TABLE: LATEST ORDERS -->
            ...
            ?>
                ...
                <div class="box-footer clearfix">
                  <a href="<?php echo base_url() ?>index.php/sales/create" class="btn btn-sm btn-info btn-flat pull-left">Nueva Orden</a>
                  <a href="<?php echo base_url() ?>index.php/sales" class="btn btn-sm btn-default btn-flat pull-right">Ver todas las ordenes</a>
                </div><!-- /.box-footer -->
              </div><!-- /.box -->
            </div><!-- /.col -->
...
$(function(){
  ...
  var salesChartData = {
    labels: ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio","Agosto","Septimbre","Octubre","Noviembre","Diciembre"],
    datasets: [
      {
        label: "Digital Goods",
