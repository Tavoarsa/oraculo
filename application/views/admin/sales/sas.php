                      ...
                      <div class="col-md-8 back-wight">
                        <div class='box-body pad'>
                          <div class="col-md-4 back-wight">
                            ...
                            <div class="form-group">
                               <label class="right-baju">Otros</label>
                            ...
                            <div class="form-group">
                                <label class="right-baju">Servicios Restaurante (%)</label><br /><br />
                            </div>
                          ...
                          <div class="col-md-8 back-wight">
                            ...
                            <div class="col-md-6 back-wight">
                              <input  hidden="true" type="text" readonly="readonly" name="txtsales_tax_value" id="grand_other_tax" class="form-control tax-sales-d " value="10" /><br />
                     ...
                     <!-- <div class="form-group">
                      ...
                      <br />
                       ...
                       <div  class="form-group">
                               ...
                               <input type="text" name="txtopay" id="other_pay" class="form-control "  value="" onkeyup="javascript:othertaxcount();"/><br />
                        </div> 
                ...
                <section class="popupBody">
                  ...
                  <div class="social_login">
                    <div class="">
                          ...
                          <input type="button" name="btnsubmit" onclick="addpay();"  style="float:right;" class="btn btn-primary" value="Confirmar" />
